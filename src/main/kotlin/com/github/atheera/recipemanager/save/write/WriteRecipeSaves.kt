...
class WriteRecipeSaves(title: String, cat: String, subCat: String, instr: String, ingr: MutableList<String>, temp: Int, cTemp: Int, egg: Boolean, gluten: Boolean, lactose: Boolean, vegan: Boolean, veget: Boolean) {
